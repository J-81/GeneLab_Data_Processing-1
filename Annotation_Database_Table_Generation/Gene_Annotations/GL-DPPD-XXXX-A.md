...
> **This page holds an overview and documents the generation of database gene annotation files used. Exact processing commands for specific database files that have been released is available in this repository [GLDS_Database_File_Scripts](GLDS_Database_File_Scripts) sub-directory.**  
